 ...
 * Exercise 25_11 (Display Tree) Write a new view class that displays the tree horizontally with the root on the left as show
 * in figure 25.23
 * 
 * */
...
public class BSTAnimation extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        BTSideView view = new BTSideView(tree); // Create a *BTSideView*
        pane.setCenter(view);
